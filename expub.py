...
class Book(object):
    def __init__(self, out_name, metadata, content_dir='OEBPS/'):
        ...
        self.add('mimetype', 'application/expub+zip', deflate=False)
        ...
        for id, href, media_type in [('css', 'stylesheet.css', 'text/css')]:
            content_src = os.path.join(sys.path[0], 'expub_files', href)
    ...
    def make_xhtml(self):
        html = E.html(
            E.head(
                ...
                E.meta(name='generator', content='abbyy to expub tool, v0.2'),
