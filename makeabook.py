...
def htmlimg(block,leafno,page=False):
  ...
  if ((imgdir) and (page) and (iabook)):
      ...
      image_stream=urlopen("http://archivestream.github.io/BookReader/BookReaderImages.php?zip=/")
...
print "<link rel='sbook.refuri' href='http://www.archivestream.github.io/sbooks/%s/index.html'/>"%bookid
print "<style>"
